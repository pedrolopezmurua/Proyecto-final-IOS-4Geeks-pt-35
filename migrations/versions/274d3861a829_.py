...
Revision ID: 274d3861a829
Revises: 989381f76d88
Create Date: 2023-05-12 22:10:02.571237
...
revision = '274d3861a829'
down_revision = '989381f76d88'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('contrasena', sa.String(length=8), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('cobertura_servicio', sa.String(length=200), nullable=True),
