...
Revision ID: 4d7209663625
Revises: ff14f4aa0922
Create Date: 2023-05-30 22:26:30.948377
...
revision = '4d7209663625'
down_revision = 'ff14f4aa0922'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('proveedor',
                    ...
                    sa.Column('red_social', sa.String(
    ...
    op.create_table('imagen_servicio',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('secure_url', sa.String(
